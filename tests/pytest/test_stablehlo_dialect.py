...
"""Unit test module for xdsl_jax.dialects.stablehlo."""
...
def test_all_unary_operations(run_filecheck: Any) -> None:
...
def test_all_other_operations(run_filecheck: Any) -> None:
...
def test_invalid_ir_shape_mismatch(
    run_filecheck: Any,
) -> None:
...
def test_invalid_ir_type_mismatch(
    run_filecheck: Any,
) -> None:
...
def test_invalid_ir_missing_operands(
    run_filecheck: Any,
) -> None:
...
def test_invalid_ir_trait_verification_failure(
    run_filecheck: Any,
) -> None:
...
def test_invalid_ir_operand_result_shape_mismatch(
    run_filecheck: Any,
) -> None:
...
def test_data_movement_operations(
    run_filecheck: Any,
) -> None:
...
def test_invalid_slice_operations(
    run_filecheck: Any,
) -> None:
...
def test_invalid_slice_element_type_mismatch(
    run_filecheck: Any,
) -> None:
...
def test_invalid_gather_element_type_mismatch(
    run_filecheck: Any,
) -> None:
...
def test_invalid_reshape_operations(
    run_filecheck: Any,
) -> None:
...
def test_invalid_broadcast_in_dim_operations(
    run_filecheck: Any,
) -> None:
    ...
    with pytest.raises(
        Exception, match="broadcast_dimensions size .* does not match operand rank"
    ):
    ...
    with pytest.raises(
        Exception, match="broadcast_dimensions should not have duplicates"
    ):
...
def test_dynamism_operations(run_filecheck: Any) -> None:
...
def test_reduction_operations(run_filecheck: Any) -> None:
...
def test_invalid_reduction_operations(
    run_filecheck: Any,
) -> None:
    ...
    with pytest.raises(
        Exception, match=r"input and init_value must have the same element type"
    ):
    ...
    with pytest.raises(
        Exception, match=r"reducer must return exactly one value per input"
    ):
        run_filecheck(program_return_count, roundtrip=True, verify=True)


def test_custom_call_basic(run_filecheck: Any) -> None:
...
def test_custom_call_with_layouts(
    run_filecheck: Any,
) -> None:
...
def test_custom_call_missing_result_layouts(
    run_filecheck: Any,
) -> None:
...
def test_custom_call_layouts_mismatch(
    run_filecheck: Any,
) -> None:
...
def test_custom_call_incorrect_layout_perm(
    run_filecheck: Any,
) -> None:
...
def test_custom_call_single_tuple_result_with_element_layouts(
    run_filecheck: Any,
) -> None:
...
def test_invalid_dynamic_broadcast_in_dim_operations(
    run_filecheck: Any,
) -> None:
    ...
    with pytest.raises(
        Exception,
        match=r"broadcast_dimensions size \(1\) does not match operand rank \(2\)",
    ):
    ...
    with pytest.raises(
        Exception, match=r"result rank \(1\) is less than operand rank \(2\)"
    ):
    ...
    with pytest.raises(
        Exception, match=r"broadcast_dimensions should not have duplicates"
    ):
    ...
    with pytest.raises(
        Exception,
        match=r"broadcast_dimensions contains invalid value 2 for result with rank 2",
    ):
        run_filecheck(program_dim_oob, roundtrip=True, verify=True)
