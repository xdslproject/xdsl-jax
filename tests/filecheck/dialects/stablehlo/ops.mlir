...
// CHECK-JAX: %{{\w+}} = stablehlo.abs %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.abs %{{\w+}} : (tensor<complex<f32>>) -> tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.cbrt %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.ceil %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.convert %{{\w+}} : (tensor<i32>) -> tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.cosine %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.count_leading_zeros %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.exponential_minus_one %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.exponential %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.imag %{{\w+}} : (tensor<complex<f32>>) -> tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.negate %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.floor %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.is_finite %{{\w+}} : (tensor<f32>) -> tensor<i1>
...
// CHECK-JAX: %{{\w+}} = stablehlo.logistic %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.log %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.log_plus_one %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.not %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.popcnt %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.real %{{\w+}} : (tensor<complex<f32>>) -> tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.round_nearest_afz %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.round_nearest_even %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.rsqrt %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.sign %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.sine %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.sqrt %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.tan %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.tanh %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.add %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.and %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.atan2 %{{\w+}}, %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.complex %{{\w+}}, %{{\w+}} : tensor<complex<f32>>
...
// CHECK-JAX: %{{\w+}} = stablehlo.complex %{{\w+}}, %{{\w+}} : tensor<5xcomplex<f32>>
...
// CHECK-JAX: %{{\w+}} = stablehlo.divide %{{\w+}}, %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.maximum %{{\w+}}, %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.minimum %{{\w+}}, %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.multiply %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.or %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.power %{{\w+}}, %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.remainder %{{\w+}}, %{{\w+}} : tensor<f32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.shift_left %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.shift_right_arithmetic %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.shift_right_logical %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.subtract %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.xor %{{\w+}}, %{{\w+}} : tensor<i32>
...
// CHECK-GENERIC: %ob0, %ob1 = "stablehlo.optimization_barrier"(%t0, %t0) : (tensor<i32>, tensor<i32>) -> (tensor<i32>, tensor<i32>)
...
// CHECK-JAX: %{{\w+}} = stablehlo.after_all %{{\w+}}, %{{\w+}} : !stablehlo.token
...
// CHECK-JAX: %{{\w+}} = stablehlo.transpose %{{\w+}}, dims = [2, 1, 0] : (tensor<2x3x2xi32>) -> tensor<2x3x2xi32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.pad %{{\w+}}, %{{\w+}}, low = [0, 1], high = [2, 1], interior = [1, 2] : (tensor<2x3xi32>, tensor<i32>) -> tensor<5x9xi32>
...
// CHECK-JAX: %{{\w+}} = stablehlo.bitcast_convert %{{\w+}} : (tensor<i32>) -> tensor<2xi16>
...
// CHECK-JAX: %{{\w+}}:2 = "stablehlo.case"(%{{\w+}}) ({
%0:2 = "stablehlo.case"(%index) ({
  ...
  // CHECK-JAX:    stablehlo.return %{{\w+}}, %{{\w+}} : tensor<2xi64>, tensor<2xi64>
...
// CHECK-JAX:  }) : (tensor<i32>) -> (tensor<2xi64>, tensor<2xi64>)
