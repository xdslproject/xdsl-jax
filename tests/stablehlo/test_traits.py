...
from xdsl_jax.dialects.stablehlo.traits import CompatibleOperandsAndResultType

AnyTensorType: TypeAlias = TensorType[Attribute]


@irdl_op_definition
class TensorCompatOp(IRDLOperation):
    name = "test.tensor_compat"
