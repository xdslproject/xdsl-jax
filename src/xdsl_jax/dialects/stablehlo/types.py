...
# pyright: reportPrivateImportUsage=false, reportUnknownParameterType=false, reportUnknownVariableType=false, reportInvalidTypeForm=false, reportUnknownArgumentType=false, reportArgumentType=false
...
from xdsl_jax.dialects._stablehlo_upstream import TokenType
from xdsl_jax.xdsl_extras.constraints import (
...
HLO_SignedInt = _create_param_constrained_type(
    IntegerType, _HLO_INT_WIDTHS, Signedness.SIGNED
)
HLO_UnsignedInt = _create_param_constrained_type(
    IntegerType, _HLO_INT_WIDTHS, Signedness.UNSIGNED
)
...
HLO_IntOrPred = _create_param_constrained_type(
    IntegerType, _HLO_INT_OR_PRED_WIDTHS, None
)
...
HLO_PerAxisQuantizedInt: TypeAlias = (
    HLO_PerAxisQuantizedSignedInt | HLO_PerAxisQuantizedUnsignedInt
)
...
HLO_Tensor: TypeAlias = TensorType[
    HLO_Float | HLO_Complex | HLO_IntOrPred | HLO_QuantizedInt
]
