...
from xdsl_jax.xdsl_extras import Elementwise, SameOperandsAndResultShape
...
@irdl_op_definition
class ConvertOp(
    ElementwiseUnaryOperation[HLO_NonQuantizedTensor, HLO_NonQuantizedTensor]
):
    """
...
class CosineOp(
    ElementwiseUnaryOperation[
        HLO_FpComplexOrQuantizedIntTensor, HLO_FpComplexOrQuantizedIntTensor
    ]
):
    """
